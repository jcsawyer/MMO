<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Farm.ascx.cs" Inherits="AJSGame.Controls.Farm" %>
<div id="title">
    <h2>
        <asp:Label ID="TitleLabel" runat="server" Text=""></asp:Label></h2>
</div>
<p>
    The Farm is based in the fields of your village. Here your citizens come to produce foods. Upgrading your Farm increases your hourly production of food.
</p>
<ul>
    <li>
        <a class="tile">
