<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shelter.ascx.cs" Inherits="AJSGame.Controls.Shelter" %>
<div id="title">
    <h2>
        <asp:Label ID="TitleLabel" runat="server" Text=""></asp:Label></h2>
</div>
<p>
    The Shelter is a safe deposit for your village's resource to keep attackers from looting them. Upgrading your Shelter increases the storage capacity.
</p>
<ul>
    <li>
        <a class="tile">
