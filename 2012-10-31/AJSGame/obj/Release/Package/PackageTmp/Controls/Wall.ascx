<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Wall.ascx.cs" Inherits="AJSGame.Controls.Wall" %>
<div id="title">
    <h2>
        <asp:Label ID="TitleLabel" runat="server" Text=""></asp:Label></h2>
</div>
<p>
    The Wall surrounds your village to help keep attackers our by raising the defence level. Upgrading your Wall increases the defence bonus.
</p>
<ul>
    <li>
        <a class="tile">
            ...
            <br />
            <span class="tilebody">Current defence bonus.
            </span>
        </a>
    </li>
    <li>
