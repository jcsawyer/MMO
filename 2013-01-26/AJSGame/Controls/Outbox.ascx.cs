...
{
    public partial class Outbox : AJSGame.Core.ControlBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                InboxGridView.DataSource = AJSGame.Objects.Message.GetMessages("sender = '" + AJSGame.Game.Session.User.Username + "' AND type = 'outbox'");
