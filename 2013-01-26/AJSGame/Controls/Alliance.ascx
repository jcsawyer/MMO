<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Alliance.ascx.cs" Inherits="AJSGame.Controls.Alliance" %>
<div id="title">
    <h2>
...
<table width="100%">
    <tr>
        ...
        <td valign="top">
            ...
            <br />
            <asp:HyperLink ID="EditAllianceHyperLink" runat="server" Text="Edit Alliance" NavigateUrl="~/alliance.aspx?mode=edit" Visible="false"></asp:HyperLink>
        </td>
    </tr>
</table>