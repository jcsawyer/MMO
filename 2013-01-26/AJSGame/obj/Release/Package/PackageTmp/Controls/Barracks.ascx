<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Barracks.ascx.cs" Inherits="AJSGame.Controls.Barracks" %>
<div id="title">
    <h2>
        <asp:Label ID="TitleLabel" runat="server" Text=""></asp:Label></h2>
</div>
<p>
    The Barracks is where your village trains it's units. Upgrading your Barracks decreases the time to train units.
</p>
<ul>
    <li>
        <a class="tile">
            ...
            <div class="tile" style="width: 240px;">
                ...
                <span class="tilebody">
                    ...
                    <asp:Panel ID="SpearmanPanel" runat="server" Visible="false">
                        <ul>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Wood.gif" /><%= AJSGame.Objects.Unit.GetUnit("spear").Wood.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Clay.gif" /><%= AJSGame.Objects.Unit.GetUnit("spear").Clay.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Metal.gif" /><%= AJSGame.Objects.Unit.GetUnit("spear").Metal.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Food.gif" /><%= AJSGame.Objects.Unit.GetUnit("spear").Food.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Time.gif" /><%= AJSGame.Core.Functions.TimeReducedRecruitment(AJSGame.Game.Session.Village, AJSGame.Objects.Unit.GetUnit("spear").Time, "infantry").ToString().Substring(0, 8) %></li>
                        </ul>
                        <asp:TextBox ID="SpearmanTextBox" runat="server" Text="0" TextMode="Number" CssClass="textbox" Width="30px"></asp:TextBox>
                        <asp:LinkButton ID="SpearmanMaxButton" runat="server" ForeColor="White" OnClick="SpearmanMaxButton_Click"><%= "(" + AJSGame.Core.Functions.MaxUnits(AJSGame.Game.Session.Village, "spear") + ")" %></asp:LinkButton>
            ...
            <div class="tile" style="width: 240px;">
                ...
                <span class="tilebody">
                    ...
                    <asp:Panel ID="SwordsmanPanel" runat="server" Visible="false">
                        <ul>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Wood.gif" /><%= AJSGame.Objects.Unit.GetUnit("sword").Wood.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Clay.gif" /><%= AJSGame.Objects.Unit.GetUnit("sword").Clay.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Metal.gif" /><%= AJSGame.Objects.Unit.GetUnit("sword").Metal.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Food.gif" /><%= AJSGame.Objects.Unit.GetUnit("sword").Food.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Time.gif" /><%= AJSGame.Core.Functions.TimeReducedRecruitment(AJSGame.Game.Session.Village, AJSGame.Objects.Unit.GetUnit("sword").Time, "infantry").ToString().Substring(0, 8) %></li>
                        </ul>
                        <asp:TextBox ID="SwordsmanTextBox" runat="server" Text="0" TextMode="Number" CssClass="textbox" Width="30px"></asp:TextBox>
                        <asp:LinkButton ID="SwordsmanMaxButton" runat="server" ForeColor="White" OnClick="SwordsmanMaxButton_Click"><%= "(" + AJSGame.Core.Functions.MaxUnits(AJSGame.Game.Session.Village, "sword") + ")" %></asp:LinkButton>
            ...
            <div class="tile" style="width: 240px;">
                ...
                <span class="tilebody">
                    ...
                    <asp:Panel ID="AxemanPanel" runat="server" Visible="false">
                        <ul>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Wood.gif" /><%= AJSGame.Objects.Unit.GetUnit("axe").Wood.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Clay.gif" /><%= AJSGame.Objects.Unit.GetUnit("axe").Clay.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Metal.gif" /><%= AJSGame.Objects.Unit.GetUnit("axe").Metal.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Food.gif" /><%= AJSGame.Objects.Unit.GetUnit("axe").Food.ToString() %></li>
                            <li>
                                <img width="9px" height="9px" src="Images/Resources/Time.gif" /><%= AJSGame.Core.Functions.TimeReducedRecruitment(AJSGame.Game.Session.Village, AJSGame.Objects.Unit.GetUnit("axe").Time, "infantry").ToString().Substring(0, 8) %></li>
                        </ul>
                        <asp:TextBox ID="AxemanTextBox" runat="server" Text="0" TextMode="Number" CssClass="textbox" Width="30px"></asp:TextBox>
                        <asp:LinkButton ID="AxemanMaxButton" runat="server" ForeColor="White" OnClick="AxemanMaxButton_Click"><%= "(" + AJSGame.Core.Functions.MaxUnits(AJSGame.Game.Session.Village, "axe") + ")" %></asp:LinkButton>
