<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Mine.ascx.cs" Inherits="AJSGame.Controls.Mine" %>
<div id="title">
    <h2>
        <asp:Label ID="TitleLabel" runat="server" Text=""></asp:Label></h2>
</div>
<p>
    The Mine is based in the ore deposits of your village. Here your citizens come to mine metal. Upgrading your Mine increases your hourly production of metal.
</p>
<ul>
    <li>
        <a class="tile">
