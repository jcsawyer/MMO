<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Warehouse.ascx.cs" Inherits="AJSGame.Controls.Warehouse" %>
<div id="title">
    <h2>
        <asp:Label ID="TitleLabel" runat="server" Text=""></asp:Label></h2>
</div>
<p>
    The Warehouse is where your village stores it's collected resources. Upgrading your Warehouse increases your resource capacity.
</p>
<ul>
    <li>
        <a class="tile">
