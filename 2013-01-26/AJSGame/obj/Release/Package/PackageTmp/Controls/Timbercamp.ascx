<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Timbercamp.ascx.cs" Inherits="AJSGame.Controls.Timbercamp" %>
<div id="title">
    <h2>
        <asp:Label ID="TitleLabel" runat="server" Text=""></asp:Label></h2>
</div>
<p>
    The Timbercamp is based in the woodland of your village. Here your citizens come to chop wood. Upgrading your Timbercamp increases your hourly production of wood.
</p>
<ul>
    <li>
        <a class="tile">
